...
public abstract class BaseConfigurationResourceTestCase {
	...
	public void testPutConfigurationByExternalReferenceCode() throws Exception {
		Configuration postConfiguration =
			testPutConfigurationByExternalReferenceCode_addConfiguration();
		...
		Configuration getConfiguration =
			testPutConfigurationByExternalReferenceCode_getConfiguration(
		...
		Configuration newConfiguration =
			testPutConfigurationByExternalReferenceCode_createConfiguration();

		putConfiguration =
			configurationResource.putConfigurationByExternalReferenceCode(
				newConfiguration.getExternalReferenceCode(), newConfiguration);

		assertEquals(newConfiguration, putConfiguration);
		assertValid(putConfiguration);
		...
		assertEquals(newConfiguration, getConfiguration);

		Assert.assertEquals(
			newConfiguration.getExternalReferenceCode(),
			putConfiguration.getExternalReferenceCode());
	}
...
// LIFERAY-REST-BUILDER-HASH:1181971536