...
public abstract class BaseConfigurationResourceImpl
	 ...
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/ai-hub/v1.0/configurations/by-external-reference-code/{externalReferenceCode}' -d $'{"environmentUrls": ___, "recipientEmailAddress": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.PUT
	@Override
	public Configuration putConfigurationByExternalReferenceCode(
...
// LIFERAY-REST-BUILDER-HASH:541558040