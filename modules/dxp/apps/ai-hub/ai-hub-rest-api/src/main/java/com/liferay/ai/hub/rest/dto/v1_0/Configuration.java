...
public class Configuration implements Serializable {
	...
	public String getEnvironmentUrls() {
		if (_environmentUrlsSupplier != null) {
			environmentUrls = _environmentUrlsSupplier.get();

			_environmentUrlsSupplier = null;
		}
	...
	public void setEnvironmentUrls(
		...
		_environmentUrlsSupplier = () -> {
			try {
				return environmentUrlsUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<String> _environmentUrlsSupplier;
	...
	public String toString() {
		...
		String environmentUrls = getEnvironmentUrls();
		...
		if (environmentUrls != null) {
			...
			sb.append(_escape(environmentUrls));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.ai.hub.rest.dto.v1_0.Configuration",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-473147223