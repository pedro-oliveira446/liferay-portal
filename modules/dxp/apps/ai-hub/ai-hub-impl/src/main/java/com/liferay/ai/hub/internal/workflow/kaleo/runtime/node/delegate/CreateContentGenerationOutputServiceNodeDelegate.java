...
package com.liferay.ai.hub.internal.workflow.kaleo.runtime.node.delegate;
...
public class CreateContentGenerationOutputServiceNodeDelegate
	...
	public String execute(
		...
		if (Validator.isNull(contentEntriesPayload)) {
			throw new IllegalStateException(
				"The content generation step returned no payload");
		}
	...
	public String getKey() {
		return "javaDelegate#createContentGenerationOutput";
	}
