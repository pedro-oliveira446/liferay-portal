...
public class ObjectEntryVersionServiceHttp {
	...
	public static com.liferay.object.model.ObjectEntryVersion
			deleteObjectEntryVersion(
				...
				long companyId, long groupId, int version)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				ObjectEntryVersionServiceUtil.class, "deleteObjectEntryVersion",
				_deleteObjectEntryVersionParameterTypes1);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, externalReferenceCode, companyId, groupId, version);
	...
	private static final Class<?>[] _deleteObjectEntryVersionParameterTypes1 =
		new Class[] {String.class, long.class, long.class, int.class};
