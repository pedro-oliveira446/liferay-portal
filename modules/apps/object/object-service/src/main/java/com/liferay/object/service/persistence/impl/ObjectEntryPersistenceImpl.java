...
public class ObjectEntryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByRootObjectEntryId;
	private FinderPath _finderPathWithoutPaginationFindByRootObjectEntryId;
	private FinderPath _finderPathCountByRootObjectEntryId;
	 ...
	 */
	@Override
	public List<ObjectEntry> findByRootObjectEntryId(long rootObjectEntryId) {
		return findByRootObjectEntryId(
			rootObjectEntryId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<ObjectEntry> findByRootObjectEntryId(
		long rootObjectEntryId, int start, int end) {

		return findByRootObjectEntryId(rootObjectEntryId, start, end, null);
	}
	...
	public List<ObjectEntry> findByRootObjectEntryId(
		...
		return findByRootObjectEntryId(
			rootObjectEntryId, start, end, orderByComparator, true);
	}
	...
	public List<ObjectEntry> findByRootObjectEntryId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByRootObjectEntryId;
				finderArgs = new Object[] {rootObjectEntryId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByRootObjectEntryId;
			finderArgs = new Object[] {
				rootObjectEntryId, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_ROOTOBJECTENTRYID_ROOTOBJECTENTRYID_2);
	...
	public ObjectEntry findByRootObjectEntryId_First(
		...
		ObjectEntry objectEntry = fetchByRootObjectEntryId_First(
			rootObjectEntryId, orderByComparator);
	...
	public ObjectEntry fetchByRootObjectEntryId_First(
		...
		List<ObjectEntry> list = findByRootObjectEntryId(
			rootObjectEntryId, 0, 1, orderByComparator);
	...
	public ObjectEntry findByRootObjectEntryId_Last(
		...
		ObjectEntry objectEntry = fetchByRootObjectEntryId_Last(
			rootObjectEntryId, orderByComparator);
	...
	public ObjectEntry fetchByRootObjectEntryId_Last(
		...
		int count = countByRootObjectEntryId(rootObjectEntryId);
		...
		List<ObjectEntry> list = findByRootObjectEntryId(
			rootObjectEntryId, count - 1, count, orderByComparator);
	...
	public ObjectEntry[] findByRootObjectEntryId_PrevAndNext(
		...
		try {
			...
			array[0] = getByRootObjectEntryId_PrevAndNext(
				session, objectEntry, rootObjectEntryId, orderByComparator,
				true);

			array[1] = objectEntry;

			array[2] = getByRootObjectEntryId_PrevAndNext(
				session, objectEntry, rootObjectEntryId, orderByComparator,
				false);
	...
	protected ObjectEntry getByRootObjectEntryId_PrevAndNext(
	...
	public void removeByRootObjectEntryId(long rootObjectEntryId) {
		for (ObjectEntry objectEntry :
				findByRootObjectEntryId(
					rootObjectEntryId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int countByRootObjectEntryId(long rootObjectEntryId) {
		FinderPath finderPath = _finderPathCountByRootObjectEntryId;

		Object[] finderArgs = new Object[] {rootObjectEntryId};
	...
	private static final String
		_FINDER_COLUMN_ROOTOBJECTENTRYID_ROOTOBJECTENTRYID_2 =
			"objectEntry.rootObjectEntryId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByRootObjectEntryId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByRootObjectEntryId",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"rootObjectEntryId"}, true);

		_finderPathWithoutPaginationFindByRootObjectEntryId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByRootObjectEntryId", new String[] {Long.class.getName()},
			new String[] {"rootObjectEntryId"}, true);

		_finderPathCountByRootObjectEntryId = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByRootObjectEntryId", new String[] {Long.class.getName()},
			new String[] {"rootObjectEntryId"}, false);
