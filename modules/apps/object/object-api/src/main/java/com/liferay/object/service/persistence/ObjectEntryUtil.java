...
public class ObjectEntryUtil {
	 ...
	 * @return the matching object entries
	 */
	public static List<ObjectEntry> findByRootObjectEntryId(
		long rootObjectEntryId) {

		return getPersistence().findByRootObjectEntryId(rootObjectEntryId);
	}
	...
	public static List<ObjectEntry> findByRootObjectEntryId(
		...
		return getPersistence().findByRootObjectEntryId(
			rootObjectEntryId, start, end);
	}
	...
	public static List<ObjectEntry> findByRootObjectEntryId(
		...
		return getPersistence().findByRootObjectEntryId(
			rootObjectEntryId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchObjectEntryException if a matching object entry could not be found
	 */
	public static ObjectEntry findByRootObjectEntryId_First(
			long rootObjectEntryId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectEntryException {

		return getPersistence().findByRootObjectEntryId_First(
	 ...
	 * @return the first matching object entry, or <code>null</code> if a matching object entry could not be found
	 */
	public static ObjectEntry fetchByRootObjectEntryId_First(
		long rootObjectEntryId,
		OrderByComparator<ObjectEntry> orderByComparator) {

		return getPersistence().fetchByRootObjectEntryId_First(
			rootObjectEntryId, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectEntryException if a matching object entry could not be found
	 */
	public static ObjectEntry findByRootObjectEntryId_Last(
			long rootObjectEntryId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectEntryException {

		return getPersistence().findByRootObjectEntryId_Last(
			rootObjectEntryId, orderByComparator);
	}
	 ...
	 * @return the last matching object entry, or <code>null</code> if a matching object entry could not be found
	 */
	public static ObjectEntry fetchByRootObjectEntryId_Last(
		long rootObjectEntryId,
		OrderByComparator<ObjectEntry> orderByComparator) {

		return getPersistence().fetchByRootObjectEntryId_Last(
			rootObjectEntryId, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectEntryException if a object entry with the primary key could not be found
	 */
	public static ObjectEntry[] findByRootObjectEntryId_PrevAndNext(
			long objectEntryId, long rootObjectEntryId,
			OrderByComparator<ObjectEntry> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectEntryException {

		return getPersistence().findByRootObjectEntryId_PrevAndNext(
			objectEntryId, rootObjectEntryId, orderByComparator);
	}
	 ...
	 * @param rootObjectEntryId the root object entry ID
	 */
	public static void removeByRootObjectEntryId(long rootObjectEntryId) {
		getPersistence().removeByRootObjectEntryId(rootObjectEntryId);
	}
	 ...
	 * @return the number of matching object entries
	 */
	public static int countByRootObjectEntryId(long rootObjectEntryId) {
		return getPersistence().countByRootObjectEntryId(rootObjectEntryId);
	}
