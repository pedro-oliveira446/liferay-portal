...
public class RichTextDDMFormFieldTemplateContextContributor
	...
	public Map<String, Object> getParameters(
		...
		boolean objectFieldLocalized =
			Validator.isNotNull(
				ddmFormField.getProperty("objectFieldLocalized")) &&
			(boolean)ddmFormField.getProperty("objectFieldLocalized");
		...
		return HashMapBuilder.<String, Object>put(
			...
			"objectFieldLocalized", objectFieldLocalized
		).put(
			"predefinedValue",
			() -> {
				if (objectFieldLocalized) {
