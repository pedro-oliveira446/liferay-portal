...
public interface CommentResource {
	...
	public Page<Comment> getObjectEntryCommentsPage(
			Long objectEntryId, String search, List<String> aggregations,
			String filterString, Pagination pagination, String sortString)
		throws Exception;

	public HttpInvoker.HttpResponse getObjectEntryCommentsPageHttpResponse(
			Long objectEntryId, String search, List<String> aggregations,
			String filterString, Pagination pagination, String sortString)
		throws Exception;
	...
	public static class CommentResourceImpl implements CommentResource {
		...
		public Page<Comment> getObjectEntryCommentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getObjectEntryCommentsPageHttpResponse(
					objectEntryId, search, aggregations, filterString,
					pagination, sortString);
		...
		public HttpInvoker.HttpResponse getObjectEntryCommentsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/object-entry/{objectEntryId}/comments");
