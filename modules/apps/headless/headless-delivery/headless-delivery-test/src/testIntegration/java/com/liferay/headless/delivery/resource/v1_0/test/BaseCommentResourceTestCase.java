...
public abstract class BaseCommentResourceTestCase {
	...
	@Test
	public void testGetObjectEntryCommentsPage() throws Exception {
		Long objectEntryId = testGetObjectEntryCommentsPage_getObjectEntryId();
		Long irrelevantObjectEntryId =
			testGetObjectEntryCommentsPage_getIrrelevantObjectEntryId();

		Page<Comment> page = commentResource.getObjectEntryCommentsPage(
			objectEntryId, null, null, null, Pagination.of(1, 10), null);

		Assert.assertEquals(0, page.getTotalCount());

		if (irrelevantObjectEntryId != null) {
			Comment irrelevantComment =
				testGetObjectEntryCommentsPage_addComment(
					irrelevantObjectEntryId, randomIrrelevantComment());

			page = commentResource.getObjectEntryCommentsPage(
				irrelevantObjectEntryId, null, null, null, Pagination.of(1, 2),
				null);
			...
			assertValid(
				page,
				testGetObjectEntryCommentsPage_getExpectedActions(
					irrelevantObjectEntryId));
		}

		Comment comment1 = testGetObjectEntryCommentsPage_addComment(
			objectEntryId, randomComment());

		Comment comment2 = testGetObjectEntryCommentsPage_addComment(
			objectEntryId, randomComment());
		...
		assertValid(
			page,
			testGetObjectEntryCommentsPage_getExpectedActions(objectEntryId));
	...
	@Test
	public void testGetObjectEntryCommentsPageWithFilterDateTimeEquals()
		throws Exception {
		...
		comment1 = testGetObjectEntryCommentsPage_addComment(
			objectEntryId, comment1);
	...
	@Test
	public void testGetObjectEntryCommentsPageWithFilterDoubleEquals()
		throws Exception {
	...
	@Test
	public void testGetObjectEntryCommentsPageWithFilterStringEquals()
		throws Exception {
	...
	@Test
	public void testGetObjectEntryCommentsPageWithPagination()
		throws Exception {
		...
		Comment comment3 = testGetObjectEntryCommentsPage_addComment(
			objectEntryId, randomComment());

		Page<Comment> page1 = commentResource.getObjectEntryCommentsPage(
			objectEntryId, null, null, null, Pagination.of(1, 2), null);

		List<Comment> comments1 = (List<Comment>)page1.getItems();

		Assert.assertEquals(comments1.toString(), 2, comments1.size());

		Page<Comment> page2 = commentResource.getObjectEntryCommentsPage(
			objectEntryId, null, null, null, Pagination.of(2, 2), null);
		...
		Page<Comment> page3 = commentResource.getObjectEntryCommentsPage(
			objectEntryId, null, null, null, Pagination.of(1, 3), null);
	...
	@Test
	public void testGetObjectEntryCommentsPageWithSortDateTime()
		throws Exception {

		testGetObjectEntryCommentsPageWithSort(
			EntityField.Type.DATE_TIME,
			(entityField, comment1, comment2) -> {
				BeanTestUtil.setProperty(
					comment1, entityField.getName(),
	...
	@Test
	public void testGetObjectEntryCommentsPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetObjectEntryCommentsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetObjectEntryCommentsPageWithSortString()
		throws Exception {
	...
	protected void testGetObjectEntryCommentsPageWithSort(
			EntityField.Type type,
			UnsafeTriConsumer<EntityField, Comment, Comment, Exception>
				unsafeTriConsumer)
		throws Exception {
		...
		comment2 = testGetObjectEntryCommentsPage_addComment(
			objectEntryId, comment2);

		for (EntityField entityField : entityFields) {
			Page<Comment> ascPage = commentResource.getObjectEntryCommentsPage(
				objectEntryId, null, null, null, Pagination.of(1, 2),
				entityField.getName() + ":asc");
			...
			Page<Comment> descPage = commentResource.getObjectEntryCommentsPage(
				objectEntryId, null, null, null, Pagination.of(1, 2),
				entityField.getName() + ":desc");
	...
	protected Comment testGetObjectEntryCommentsPage_addComment(
			Long objectEntryId, Comment comment)
		throws Exception {
	...
	protected Long testGetObjectEntryCommentsPage_getObjectEntryId()
		throws Exception {
	...
	protected Long testGetObjectEntryCommentsPage_getIrrelevantObjectEntryId()
		throws Exception {
