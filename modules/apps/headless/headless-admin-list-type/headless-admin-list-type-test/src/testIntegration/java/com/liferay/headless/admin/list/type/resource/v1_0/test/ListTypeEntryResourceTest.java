	...
	public void testGetListTypeDefinitionByExternalReferenceCodeListTypeEntriesPageWithSortInteger()
		...
		testGetListTypeDefinitionByExternalReferenceCodeListTypeEntriesPageWithSort(
			...
			(entityField, listTypeEntry1, listTypeEntry2) -> {
				if (BaseListTypeDefinitionResourceTestCase.BeanTestUtil.
						hasProperty(listTypeEntry1, entityField.getName())) {

					BaseListTypeDefinitionResourceTestCase.BeanTestUtil.
						setProperty(listTypeEntry1, entityField.getName(), 0);
				}

				if (BaseListTypeDefinitionResourceTestCase.BeanTestUtil.
						hasProperty(listTypeEntry2, entityField.getName())) {

					BaseListTypeDefinitionResourceTestCase.BeanTestUtil.
						setProperty(listTypeEntry2, entityField.getName(), 1);
				}
			});
	}
