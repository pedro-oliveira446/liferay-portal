...
if (workflowEnabled) {
	workflowDefinitions = WorkflowDefinitionManagerDisplayContextUtil.getActiveWorkflowDefinitions(company.getCompanyId(), QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
}
