...
function SidePanel(props: SidePanelProps) {
	...
	const categorizationCommitMountedRef = useRef(false);
	...
	const onCategorizationMountedChange = useCallback((mounted: boolean) => {
		categorizationCommitMountedRef.current = mounted;
	}, []);
